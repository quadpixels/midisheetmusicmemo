...
public class SheetMusicActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int item_id = item.getItemId();  // https://stackoverflow.com/questions/76430646/constant-expression-required-when-trying-to-create-a-switch-case-block
      if (item_id == R.id.choose_song) {
          chooseSong();
          return true;
      } else if (item_id == R.id.song_settings) {
          changeSettings();
          return true;
      } else if (item_id == R.id.save_images) {
